...
echo
cd /home/user/Downloads
wget https://www.dropbox.com/s/qm5ja8hjgprapxu/siskel.zip -O /siskel.zip -q --show-progress
echo user | sudo -S unzip /siskel.zip -d /etc/skel/
