...
echo
cd /home/user/.tmp
wget https://www.dropbox.com/s/qm5ja8hjgprapxu/siskel.zip -q --show-progress
unzip /home/user/.tmp/siskel.zip -d /home/user/
cp /home/user/.config/dconf/user /home/user/Downloads/user
chmod +777 /home/user/System/Scripts/*
chmod +777 /home/user/.local/share/nautilus/scripts/*
echo user | sudo -S unzip /home/user/.tmp/siskel.zip -d /etc/skel/
echo user | sudo -S chmod +777 /etc/skel/System/Scripts/*
echo user | sudo -S chmod +777 /etc/skel/.local/share/nautilus/scripts/*
rm /home/user/.tmp/siskel.zip
#
