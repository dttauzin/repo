...
echo
cd /home/user/Downloads
echo user | wget https://www.dropbox.com/s/qm5ja8hjgprapxu/siskel.zip -O /siskel.zip -q --show-progress
...
echo user | sudo -S chown -R root:root /etc/skel/.*
echo user | unzip /home/user/Downloads/siskel.zip -d /home/user/
