...
echo
cd /home/user/Downloads
echo user | sudo -S wget https://www.dropbox.com/s/qm5ja8hjgprapxu/siskel.zip -O /siskel.zip -q --show-progress
echo user | sudo -S unzip /home/user/Downloads/siskel.zip -d /etc/skel/
echo user | sudo -S chmod +777 /etc/skel/System/Scripts/*
echo user | sudo -S chmod +777 /etc/skel/.local/share/nautilus/scripts/*
echo user | sudo -S chown -R root:root /etc/skel/*
echo user | sudo -S chown -R root:root /etc/skel/.*
echo user | sudo -S unzip /home/user/Downloads/siskel.zip -d /home/user/
echo user | sudo -S chmod +777 /home/user/System/Scripts/*
echo user | sudo -S chmod +777 /home/user/.local/share/nautilus/scripts/*
echo user | sudo -S chown -R user:user /home/user/*
echo user | sudo -S chown -R user:user /home/user/.*
rm /home/user/Downloads/siskel.zip
